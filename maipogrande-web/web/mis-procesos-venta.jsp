<%-- 
    Document   : mis-procesos-venta
    Created on : 08-12-2021, 18:37:29
    Author     : Asus
--%>

<%@page import="Negocio.NegocioCabeceraProcesoVenta"%>
...
<html>
    ...
    <!-- ############################ -->
        ...
        <div class="container mx-auto">
            <% 
                ArrayList<CabeceraProcesoVenta> procesosVenta = (ArrayList<CabeceraProcesoVenta>)request.getAttribute("procesosVenta");
                if(procesosVenta==null){
                    ...
                    procesosVenta = negocioCabeceraPV.listarProcesosVentaCliente(cliente.getRut());        
                }
