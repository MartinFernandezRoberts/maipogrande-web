...
import Negocio.NegocioEstadoProcesoVenta;
 ...
 * @author Asus
 */
@WebServlet(name = "CargarProcesosVenta", urlPatterns = {"/cargar-procesos-venta"})
public class CargarProcesosVenta extends HttpServlet {
