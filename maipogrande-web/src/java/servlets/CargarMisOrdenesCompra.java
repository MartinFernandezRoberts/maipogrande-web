 ...
 * @author Asus
 */
public class CargarMisOrdenesCompra extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<CabeceraOrdenCompra> listaOrdenesCompra = negocioCabeceraOrdenCompra.listarOrdenesCompraCliente(cliente.getRut());        
        
        request.setAttribute("ordenesCompra", listaOrdenesCompra);
